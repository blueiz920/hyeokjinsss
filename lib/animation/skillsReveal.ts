...
export const applyReducedState = (root: HTMLElement, trigger: HTMLElement) => {
...
const queueRunnerStart = (
  ...
  timeline.call(onRunnerStart, undefined, 0.84);
};
...
export const createRevealTimeline = ({
  ...
  queueRunnerStart(timeline, onRunnerStart);
